...
Modifications to the baseline scenario are:
  ...
  2- annual change in tillage practices, in the baseline model the change in share between 2010 and 2016 from convetional to reduced tillage was 1.6% in the UK tillage area (Eurostat 2020). For scenario 1, the rate of change needs to be increased.
